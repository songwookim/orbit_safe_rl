...
from safe.logger import configure
from safe.ppo import PPO
import orbit_tasks
...
def main():
    ...
    agent_cfg = (load_cfg_from_registry(args_cli.task, "sb3_cfg_entry_point")).get("base")
    safe_rl_cfg = load_cfg_from_registry(args_cli.task, "sb3_cfg_entry_point").get("safe_rl")
    ...
    agent = PPO(policy_arch, env, verbose=1, **agent_cfg, **safe_rl_cfg) # type: ignore
    
    # configure the logger
    new_logger = configure(log_dir, ["log"])
