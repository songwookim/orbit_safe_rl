...
from safe.common.buffers import CollisionRolloutBuffer, CollisionDictRolloutBuffer
from safe.common.policies import ContinuousCritic, BasePolicy
from safe.common.util import compute_critic_values, update_value_functions_in_env, find_variable_in_env
...
class OnPolicyAlgorithm(BaseAlgorithm):
    ...
    def __init__(
            ...
            supported_action_spaces: Optional[Tuple[gym.Space, ...]] = None,
    ...
    def forward_sample_col_prob(self, obs: Union[th.Tensor, dict], n_samples=10, reduction=None):
        ...
        #     latent_sde = self.policy.sde_features_extractor(features[0])
