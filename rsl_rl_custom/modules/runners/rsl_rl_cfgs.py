...
class RslRlPpoAlgorithmCfg:
    ...
    ## === Safety ===
    safe_largrange: bool = MISSING
    l_multiplier_init: float = MISSING
    n_lagrange_samples: int = MISSING
    collision_reward: int = MISSING
    lagrange_penalty_mean: list[int] = MISSING
    lagrange_penalty_var: list[int] = MISSING
    gamma_col_net: float = MISSING
