...
# parser.add_argument("--load_run", type=str, default=None, help="Specify run path")  # add
...
def main():
    ...
    export_policy_as_onnx(ppo_runner.alg.actor, export_model_dir, filename="policy.onnx")
